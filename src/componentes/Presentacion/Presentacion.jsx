    ...
    return (
        <section id="presentation" className="relative flex flex-col justify-center items-center h-screen">
            ...
            <div className="flex items-center gap-5">
                <a className="w-[2.65rem] h-[2.65rem] border-black rounded-md bg-black flex items-center justify-center" href=""><GitHub fill="#fff"/></a>
                <a className="" href=""><LinkedIn fill="#0a66c2"/></a>
            </div>
            <button className="text-xl border-[1px] w-24 border-black rounded-md mt-5 py-1 px-2">Ver CV</button>
            <Link to="projects" spy={true} smooth={true} offset={50} duration={500} className="absolute bottom-10">
                <Arrow />
            </Link>
        </section>
    )
