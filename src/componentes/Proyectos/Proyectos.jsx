        ...
        <section id='projects' className="relative flex flex-row justify-center items-center p-5 pt-28 max-lg:flex-col">
            <div className='flex flex-col items-center max-w-[1400px]'>
                ...
                <div className='flex flex-wrap justify-center gap-10 max-[472px]:gap-6'>
                    ...
                    description="Llamado a API/uso de Fetch basico, hecho con HTML, CSS y Javascript nativo" zoom={'xl:translate-x-[135px] xl:-translate-y-[225px]'} videoproject={primerapi} pagina={'https://primer-api.netlify.app'} repo={'https://github.com/GermanDSanchez/API'}/>
